...
namespace Hu.MachineVision.VisionPro
{
    class StationViewRawData
    {
        ...
        public static StationViewRawData[] Stations { get; set; } 
        ...
        public StationViewRawData(int ccdId)
        {
            CcdId = ccdId;
        }
        ...
        public static StationViewRawData GetStation(int ccd)
        {
            return Stations[ccd];
        }
    }
